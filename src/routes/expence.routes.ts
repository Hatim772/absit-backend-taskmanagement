...
import expenceController from '../controllers/Expence/expence.controller';
...
const ExpenceRouter: Router = Router();
const auth = new AuthHandler();
const quoteMiddleware = new QuoteMiddlware();

const expence = new expenceController();
// const quote = new QuoteContorller();


ExpenceRouter.post('/expence', expence.Create);
ExpenceRouter.get('/expence', expence.fetch);
ExpenceRouter.put('/expence', expence.update);
ExpenceRouter.delete('/expence', expence.delete);
ExpenceRouter.get('/expenceAccording', expence.fetchById);
// ExpenceRouter.post('/addProductsCreate', [auth.authenticate(), validateSchema(addProductsForQuotation)], projectCtreate.projectCreateHandler);
